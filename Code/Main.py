...
class interact(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    #__init__() inicializa la clase interact que muestra 
    def __init__(self):
    ...
    #inicializa opciones de la ventana y el modo de visualizacion en pantalla, titulo, icono
    def appMod(self):
    ...
    #define las opciones para los widgets (tamaño de los elementos en pantalla, botones menus)
    ...
    #define las conecciones para los botones, como los listeners
    ...
    #define la opcion de cambio a manual, se activa el im.flag
    def changeToManual(self):
        self.im.flag = True
        self.drawOnPages() #dibuja cuadrados manuales
        self.AutoWidget.hide()
    ...
    #funcion que dibuja rect manuales 
    def drawOnPages(self):
        if self.im.flag and self.files != []: #si flag de im. manuales y los archivos no estan vacios
            for img in self.files:   #files es una lista probable de int
    ...
    def showdataTests(self):
        # print(type(self.textPosi))
        # print(self.textPosi)
